...
{
    Module module;
    module.importsec.emplace_back(Import{"mod", "g1", ImportType::Global, {false}});
    module.globalsec.emplace_back(Global{true, GlobalInitType::global, {0}});
    ...
    module_invalid1.importsec.emplace_back(Import{"mod", "g1", ImportType::Global, {true}});
    module_invalid1.globalsec.emplace_back(Global{true, GlobalInitType::global, {0}});
    ...
    module_invalid2.globalsec.emplace_back(Global{true, GlobalInitType::constant, {42}});
    module_invalid2.globalsec.emplace_back(Global{true, GlobalInitType::global, {0}});
