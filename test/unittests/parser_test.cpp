...
TEST(parser, import_single_function)
{
    ...
    EXPECT_EQ(module.importsec[0].type, ImportType::Function);
...
TEST(parser, import_multiple)
{
    ...
    EXPECT_EQ(module.importsec[1].type, ImportType::Memory);
    ...
    EXPECT_EQ(module.importsec[2].type, ImportType::Global);
